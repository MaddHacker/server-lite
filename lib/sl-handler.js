...
class slHandler {
    ...
    constructor(utilz) {
        ...
        this._concatJsFolderPath = '';
        /* folder where concat css targets live */
        this._concatCssFolderPath = '';
    }
     ...
     */
    _logInfo() {
        this.o.i('Utilz: ' + JSON.stringify(this.utilz));
        this.o.i('WebappRoot: ' + this._webappRoot);
        this.o.i('IndexPath: ' + this._indexPath);
        this.o.i('ConcatJsFolderPath: ' + this._concatJsFolderPath);
        this.o.i('ConcatCssFolderPath: ' + this._concatCssFolderPath);
        return true;
    }
    ...
    concatenateAll(request, response, folder, ext) {
        ...
        if (query && query.files) {
            this.o.d(stringz.fmt('[concatenateAll (%{0})] query: "%{1}"', ext, query));
            ...
            files.forEach((file) => {
                ...
                this.utilz.loadDataFromFile(tmpPath).then((data) => {
                    ...
                    this.o.e(stringz.fmt('File at "%{0}" encountered error during reading. MSG: "%{1}"', tmpPath, err));
                    allData[file] = '';
                });
            });
            ...
            this.utilz.writeResponse(response, 404, stringz.fmt('Requested a concatenated %{s} file but did not provide files to concat!', ext));
        }
    }
}
