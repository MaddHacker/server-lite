 ...
 * @return {ServerLite} server with config set
 * @throws {ServerLiteException}
 */
 ...
 * 
 *   (All the events that should/can be used for the server):
...
ServerLiteConfig.prototype.__defaultOnCheckContinue = function (request, response) {
    const cfg = this;
    cfg.out.t('onCheckContinue emitted');
...
ServerLiteConfig.prototype.__defaultOnCheckExpectation = function (request, response) {
    const cfg = this;
    cfg.out.t('onCheckExpectation emitted');
...
ServerLiteConfig.prototype.__defaultOnClientError = function (error, socket) {
    const cfg = this;
    cfg.out.e('onClientError emitted with error: ' + error);
 ...
 */
ServerLiteConfig.prototype.__defaultOnConnect = function (request, socket, head) {
    const cfg = this;
    cfg.out.t('onConnect emitted');
}
...
ServerLiteConfig.prototype.__defaultOnConnection = function (socket) {
    const cfg = this;
    cfg.out.t('onConnection emitted');
}
...
ServerLiteConfig.prototype.__defaultOnError = function (error) {
    const cfg = this;
    cfg.out.e('onError emitted with error: ' + error);
}
...
module.exports = {
    ...
    ServerLiteConfig: ServerLiteConfig
};
