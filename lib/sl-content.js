 ...
 */
module.exports = {
    binary: (content) => { return Content('application/octet-stream', content); },
    text: (content) => { return Content('text/plain', content); },
    byExtension: (extension, content) => { return new Content(mimeTypes[extension] || 'application/octet-stream', content); },
    custom: Content,
    mimeTypes: mimeTypes
};
